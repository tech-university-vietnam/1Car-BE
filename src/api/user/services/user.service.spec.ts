...
describe('UserService', () => {
  ...
  describe('getUser', () => {
    it('should return an with corresponding id', async () => {
      expect(await userService.getUser("6ca40044-3f91-4805-bbf9-3efb97c7fe3c")).toHaveProperty('name','Kiskadee, great')
    });
    it('handles case with no user found', async () => {
        const result = await userService.getUser('6ca40044-3f91-4805-bbf9-3efb97c7fe3a');
  ...
  describe('createUser', () => {
    it('should return created user', async () => {
      ...
      expect(result).toEqual(expect.objectContaining({name: 'Testy McTest', email:'test@example.com'}))
    })
  })
});
